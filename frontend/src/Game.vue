<template>
    <n-layout has-sider style="height: 100vh">
        <n-layout-sider class="main-sider" bordered :collapsed-width="64" :width="100">
            <n-menu
                :indent="16"
                :collapsed-width="64"
...
const topMenuOptions = [
    {
        label: "生涯",
        key: "career",
        icon: () => h("img", { src: CareerIcon, style: "width: 20px; height: 20px;" }),
    },
    {
        label: "战绩",
        key: "record",
        icon: () => h("img", { src: RecordIcon, style: "width: 20px; height: 20px;" }),
    },
    {
        label: "助手",
        key: "assistant",
        icon: () => h("img", { src: AssistantIcon, style: "width: 20px; height: 20px;" }),
    },
];
...
const bottomMenuOptions = [
    // {label: '玩家', key: 'personal', icon: () => h('img', {src: PersonalIcon, style: 'width: 20px; height: 20px;'})},
    {
        label: "设置",
        key: "setting",
        icon: () => h("img", { src: SettingIcon, style: "width: 20px; height: 20px;" }),
    },
];
